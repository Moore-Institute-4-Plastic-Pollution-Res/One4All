---
title: "Microplastic Image Explorer"
...
knitr::include_graphics("appimages/ImageExplorerapp.png")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("appimages/ImageExplorerapp2.png")
```

The filter options will update with each filter applied to ensure that only existing images can be queried.

```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("appimages/ImageExplorerapp3.png")
```